<template>
  <div>
    <el-card style="margin:0 0 20px"><CategorySelect :show="!isShowTable" @getGoods="getGoods" /></el-card>
    <el-card>
      <!-- 展示Spu列表的表格数据 -->
      <div v-show="scene ===0">
        ...
        <el-table border style="width:100%" :data="records">
          ...
          <el-table-column label="操作" width="width">
            <template slot-scope="{row}">
              <hint-button title="添加sku" type="success" icon="el-icon-plus" size="mini" />
